// Command metha-fortune is a compatibility stub for "metha fortune".
//
// metha ships as a single binary from 0.5 on. This package still builds, so
// that "go install github.com/miku/metha/cmd/metha-fortune@latest" keeps
...
// the size.
//
// Deprecated: use "metha fortune". Removed in metha 2.0.
package main
