// Command metha-id is a compatibility stub for "metha id".
//
// metha ships as a single binary from 0.5 on. This package still builds, so
// that "go install github.com/miku/metha/cmd/metha-id@latest" keeps
...
// the size.
//
// Deprecated: use "metha id". Removed in metha 2.0.
package main
