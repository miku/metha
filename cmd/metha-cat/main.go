// Command metha-cat is a compatibility stub for "metha cat".
//
// metha ships as a single binary from 0.5 on. This package still builds, so
// that "go install github.com/miku/metha/cmd/metha-cat@latest" keeps
...
// the size.
//
// Deprecated: use "metha cat". Removed in metha 2.0.
package main
