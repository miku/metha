// Command metha-pack is a compatibility stub for "metha pack".
//
// metha ships as a single binary from 0.5 on. This package still builds, so
// that "go install github.com/miku/metha/cmd/metha-pack@latest" keeps
...
// the size.
//
// Deprecated: use "metha pack". Removed in metha 2.0.
package main
