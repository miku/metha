// Command metha-stat is a compatibility stub for "metha stat".
//
// metha ships as a single binary from 0.5 on. This package still builds, so
// that "go install github.com/miku/metha/cmd/metha-stat@latest" keeps
...
// the size.
//
// Deprecated: use "metha stat". Removed in metha 2.0.
package main
